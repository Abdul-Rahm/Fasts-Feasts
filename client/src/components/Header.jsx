...
import { buttonClick, slideTopAccount } from '../animations';
                ...
                <>
                   <div className='relative cursor-pointer'
                    ...
                    >
                       ...
                       {isMenu && (
                        <motion.div {...slideTopAccount} onMouseLeave={() => setisMenu(false)} className='px-6 py-4 w-48 bg-cardOverlay backdrop-blur-md rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4'>
                            ...
                            <motion.div {...buttonClick} onClick={signOut} className='group flex items-center justify-center px-3 py02 rounded-md shadow-md bg-gray-100 hover:bg-gray-200 gap-3'>
